...
function renderPage(opts) {
    ...
    function renderAndExit() {
        ...
        log('Render screenshot -> ' + opts.imagePath);
        /*
        ...
        */
        ...
        page.render(opts.imagePath, renderOpts);

        log('Save HAR file -> ' + opts.harPath);
        endTime = new Date();
        pageTitle = page.evaluate(function () {
            return document.title;
        });
        var har = createHAR(opts.url, pageTitle, startTime, endTime, resources);
        fs.write(opts.harPath, JSON.stringify(har, undefined, 4));
